            ...
            <div class="nav-item-list">
                <div class="nav-item">
                    <a class="nav-link" href="{{ url('/') }}">
                        <img id="homelightLogo" src="http://localhost:8080/Meal/public/images/home%20%E6%B7%BA%E7%89%88.svg" alt="首頁淺logo" height="20px" width="50px"/>
                        <span class="nav-title">首頁</span>
                    </a>
                </div>
                <div class="nav-item">
                    <a class="nav-link" href="{{ route('posts.create')}}">
                        <img id="createlightLogo" src="http://localhost:8080/Meal/public/images/create%20%E6%B7%BA.svg" alt="創建淺logo" height="20px" width="50px"/>
                        <span class="nav-title">創建飯局</span>
                    </a>
                </div>
                <div class="nav-item">
                    <a class="nav-link" href="{{ route('surprise') }}">
                        <img id="baglightLogo" src="http://localhost:8080/Meal/public/images/surprise%20%E6%B7%BA2.svg" alt="包包淺logo" height="20px" width="50px"/>
                ...
                <div class="nav-item">
                    <a class="nav-link" href="{{ route('{name}', ['name' => $user->name ?? 'None']) }}">
                        <img id="userlightLogo" src="http://localhost:8080/Meal/public/images/profile%20%E6%B7%BA2.svg" alt="使用者淺logo" height="25px" width="55px"/>
